...
var initialElements  = function(canvas_info) {
    ...
    <div class="wrapper-memes-preview-operations">
           ...
           <a hidden class="trigger-element first fileUpload btn btn-sm btn-default" target_element_triggered=".amm-addImage" id="amm-merge-image-trigger">
             <input type="file" id="addImage-logo" class="upload amm-addImage"  name="addImage"> 
                <span class="glyphicon glyphicon-picture"></span> 
                <span class="text_value">`+canvas_info.i18n.mergeImageText+`</span>
            </a> 
             <button hidden class="trigger-element btn btn-sm btn-default" id="amm-brushes">
                             <span class="glyphicon glyphicon-pencil"></span>             <span class="text_value">`+canvas_info.i18n.drawText+`</span>
            </button>      
         
            <button hidden class="responsive-button hide-responsive-button last btn btn-sm btn-default" id="amm-preview-responsive">
                             <span class="glyphicon glyphicon-eye-open"></span>             <span class="text_value">`+canvas_info.i18n.previewText+`</span>
            </button>      
                  <button hidden href="#" class="trigger-element responsive-button hide-responsive-button first fileUpload btn btn-sm btn-default" 
    ...
    <a type="submit" hidden id="all" class="generate_meme btn btn-default btn-primary form-submit" disabled="disabled" >`+canvas_info.i18n.imageGeneratorText+`</a>
    <button hidden type="submit" class="btn btn-default btn-danger form-submit reset_meme" >`+canvas_info.i18n.resetText+`</button>
    </form>
    
    </div>
   

    <div hidden class="wrapper-memes-operations">
    ...
    `+buildImagesMemes+`
     ...
     <button hidden class="add_textbox btn btn-success form-submit edit-add-textbox"  name="op" value="add_textbox" type="button">`+canvas_info.i18n.addTextBoxText+`</button>
     </div></form>
    </div>

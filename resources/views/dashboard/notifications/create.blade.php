    ...
    <div class="row">
        <div class="col-12">
            <div class="content-header">
                <h2 class="content-title"> Add New notifications </h2>
                <div>
            ...
            <div class="card mb-4">
                ...
                <form method="POST" action="{{ route('notifications.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="message_ar" id="input" class="form-control @error('message_ar') is-invalid @enderror" rows="3" required="required"> {{ old('message_ar') }} </textarea>
                        @error('name_en')
                            <p class="text-danger"> {{ $message }} </p>
                        @enderror
                    </div>
                  ...
                  <div class="mb-4">
                        ...
                        <textarea name="message_en" id="input" class="form-control @error('message_en') is-invalid @enderror" rows="3" required="required"> {{ old('message_en') }} </textarea>
                        @error('message_en')
                            <p class="text-danger"> {{ $message }} </p>
                        @enderror
                    </div>

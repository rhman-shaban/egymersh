    ...
    <div class="row">
        <div class="col-12">
            <div class="content-header">
                <h2 class="content-title"> Add New Color To Product </h2>
                <div>
        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <form method="POST" action="{{ route('product_colors.store' , ['product_id' => $product_id ]) }}" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        <div class='row mb-4' >

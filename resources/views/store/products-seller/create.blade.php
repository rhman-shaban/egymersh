    ...
    <div class="row">
        <div class="col-9">
            <div class="content-header">
                <h2 class="content-title">Product Seller</h2>
            </div>
        </div>
            ...
            <div class="col-lg-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <strong class="mr-10 mt-5 d-none-color d-none">choose Color</strong>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            {{-- <input type="text" name="ali" id="allimageaa" hidden> --}}
                            ...
                            @if (auth()->guard('seller')->user()->status == 'true')
                                ...
                                <button class="btn btn-md col-1 rounded font-sm hover-up publich-product">Publish</button>

                        ...
                        <div class="form-group">
                            <div class="custom_select">
                                <select class="form-control select-active">
                                    <option value="">Select an governorate...</option>
                        ...
                        <div class="table-responsive order_table text-center">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="image product-thumbnail"><img src="{{ asset('site_assets/assets/imgs/shop/product-2-1.jpg') }}" alt="#"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="image product-thumbnail"><img src="{{ asset('site_assets/assets/imgs/shop/product-3-1.jpg') }}" alt="#"></td>
